...
public class XmlBasedConfigurationTest extends AbstractExceptionHandlingTest
{
   ...
   {
      checkResponse("/exceptions?exception=java.lang.ArrayIndexOutOfBoundsException", 500, "<error><message>ArrayIndexOutOfBoundsException was thrown.</message></error>");
   }
   
   @Test
   public void testExpressionLanguage() throws Exception
   {
      checkResponse("/exceptions?exception=java.lang.IndexOutOfBoundsException", 500, "<error><message>An exception was thrown. The date is: ");
   }
}
