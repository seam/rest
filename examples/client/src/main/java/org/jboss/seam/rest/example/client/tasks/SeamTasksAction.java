package org.jboss.seam.rest.example.client.tasks;
...
/**
 * Loads Seam Tasks's Categories and Tasks and fires an event for each of these objects
 * for analyzers to be able to process statistics.
